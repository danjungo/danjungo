class DemosController < ApplicationController
  # Displays a page with a simple haml form
  def about
  end
  ...
  # Form action which responds to URL and search expression submitted by user.
  def post_about
    @uurl= params[:uurl]
  ...
  # Allows me to look at the aboutout.haml
  def aboutout
  ...
  # Displays a page with a several haml forms
  def index
  end
  ...
  # The actions below correspond to the forms on the index page.
  ...
  def search_prepend
    ...
    hpricot_object = get_my_hp_elem(@uurl)
    # prepend() stopped working
    @myhtml= "prepend() stopped working.  It worked okay in Hpricot 0.6"
