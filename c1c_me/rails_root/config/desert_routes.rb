#
# This file only works if it resides in 
# vendor/plugins/community_engine/config/desert_routes.rb
# If I enhance it I copy it to here:
# config/desert_routes.rb
# so it will get committed to git.
#
...
# bikle
resources :users, :member_path => '/usr/:id', :nested_member_path => '/usr/:user_id', :member => { 
    :dashboard => :get,
    :assume => :get,
